...
class WishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wish" do
    assert_difference('Wish.count') do
      post wishes_url, params: { wish: { description: @wish.description, endDate: @wish.endDate, initDate: @wish.initDate, title: @wish.title } }
    end
  ...
  test "should update wish" do
    patch wish_url(@wish), params: { wish: { description: @wish.description, endDate: @wish.endDate, initDate: @wish.initDate, title: @wish.title } }
